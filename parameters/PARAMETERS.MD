...
This is a neural network with 2 hidden layers. It is heavily based on the equivalent one in the [kaggler]( href="https://pypi.python.org/pypi/Kaggler) python package.
